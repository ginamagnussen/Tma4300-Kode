...
truehist(xsample2, xlab = "Samples of g(x), alpha = 0.2",main = "Probability integral transform", xlim = range(0:1.5), cex.main = 1.7, cex.lab = 1.5)
...
#Plot
truehist(xsample, main = "Rejection sampling", xlab = "Samples of f(x), alpha = 0.2", xlim = range(0:2), cex.main = 1.7, cex.lab = 1.5)
...
truehist(xsample2, xlab = "Samples of g(x), alpha = 0.5", xlim = range(0:2.5), cex.lab = 1.5)
lines(x,gfunc, col = "red", lwd = 3)
...
Plot
truehist(xsample, xlab = "Samples of f(x), alpha = 0.5", xlim = range(0:2.5), cex.main = 1.7, cex.lab = 1.5)
lines(x,y, col = "red", lwd = 3)
```
...
truehist(xsample2, xlab = "Samples of g(x), alpha = 0.75", xlim = range(0:4), cex.main = 2, cex.lab = 1.5)
lines(x,gfunc, col = "red", lwd = 3)
...
#Plot
truehist(xsample, xlab = "Samples of f(x), alpha = 0.9", xlim = range(0:5), cex.main = 1.7, cex.lab = 1.5)
lines(x,y, col = "red", lwd = 3)
```